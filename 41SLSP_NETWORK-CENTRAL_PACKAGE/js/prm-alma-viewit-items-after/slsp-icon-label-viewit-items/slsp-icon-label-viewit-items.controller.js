        ...
        try{
            this.$timeout(() => {
                ...
                if (this.parentCtrl.serviceType == "ELECTRONIC") {
                        ...
                        let iconLabelViewitItems = document.querySelectorAll("#getit_link1_0 > div > prm-full-view-service-container > div.section-body > div > prm-alma-viewit > prm-alma-viewit-items > md-list");
